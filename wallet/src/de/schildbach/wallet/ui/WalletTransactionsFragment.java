		...
		OnSharedPreferenceChangeListener
{
	...
	{
		if (Configuration.PREFS_KEY_ERC_PRECISION.equals(key) || Configuration.PREFS_KEY_REMIND_BACKUP.equals(key))
			updateView();
	}
	...
	private Warning warning()
	{
		...
		if (config.remindBackup())
			return Warning.BACKUP;
							...
							|| storageEncryptionStatus == DevicePolicyManager.ENCRYPTION_STATUS_ACTIVE_DEFAULT_KEY))			return Warning.STORAGE_ENCRYPTION;
		else
			return null;
	}
}
